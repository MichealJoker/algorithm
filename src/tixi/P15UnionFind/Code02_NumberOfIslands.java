...
public class Code02_NumberOfIslands {
    ...
    public static Position getParentPostition(int i ,int j){
        Position[][] s = new Position[100][100];
        int col = i;
        int row = j;
        Position position = s[i][j];
        while (position.col != col || position.row != row) {
            position = s[position.col][position.row];
        }
        return position;
    }
}